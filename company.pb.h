...
class Point final :
 ...
 public:
  ...
  private:
  bool _internal_has_foreign_activity() const;
  public:
...
// required int32 year = 1;
inline bool Point::_internal_has_year() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool Point::has_year() const {
  return _internal_has_year();
}
inline void Point::clear_year() {
  _impl_.year_ = 0;
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline int32_t Point::_internal_year() const {
  return _impl_.year_;
}
inline int32_t Point::year() const {
  // @@protoc_insertion_point(field_get:Point.year)
  return _internal_year();
}
inline void Point::_internal_set_year(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.year_ = value;
}
inline void Point::set_year(int32_t value) {
  _internal_set_year(value);
  // @@protoc_insertion_point(field_set:Point.year)
}

// required string legal_address = 2;
inline bool Point::_internal_has_legal_address() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool Point::has_legal_address() const {
  return _internal_has_legal_address();
}
inline void Point::clear_legal_address() {
  _impl_.legal_address_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const std::string& Point::legal_address() const {
  // @@protoc_insertion_point(field_get:Point.legal_address)
  return _internal_legal_address();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Point::set_legal_address(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.legal_address_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Point.legal_address)
}
inline std::string* Point::mutable_legal_address() {
  std::string* _s = _internal_mutable_legal_address();
  // @@protoc_insertion_point(field_mutable:Point.legal_address)
  return _s;
}
inline const std::string& Point::_internal_legal_address() const {
  return _impl_.legal_address_.Get();
}
inline void Point::_internal_set_legal_address(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.legal_address_.Set(value, GetArenaForAllocation());
}
inline std::string* Point::_internal_mutable_legal_address() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.legal_address_.Mutable(GetArenaForAllocation());
}
inline std::string* Point::release_legal_address() {
  // @@protoc_insertion_point(field_release:Point.legal_address)
...
inline void Point::set_allocated_legal_address(std::string* legal_address) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Point.legal_address)
}

// required string label = 3;
inline bool Point::_internal_has_label() const {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Point::set_label(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
...
inline const std::string& Point::_internal_label() const {
  return _impl_.label_.Get();
}
inline void Point::_internal_set_label(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.label_.Set(value, GetArenaForAllocation());
}
inline std::string* Point::_internal_mutable_label() {
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.label_.Mutable(GetArenaForAllocation());
}
inline std::string* Point::release_label() {
  // @@protoc_insertion_point(field_release:Point.label)
...
// optional string occupation = 4;
inline bool Point::_internal_has_occupation() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool Point::has_occupation() const {
  return _internal_has_occupation();
}
inline void Point::clear_occupation() {
  _impl_.occupation_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline const std::string& Point::occupation() const {
  // @@protoc_insertion_point(field_get:Point.occupation)
  return _internal_occupation();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Point::set_occupation(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000004u;
 _impl_.occupation_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Point.occupation)
}
inline std::string* Point::mutable_occupation() {
  std::string* _s = _internal_mutable_occupation();
  // @@protoc_insertion_point(field_mutable:Point.occupation)
  return _s;
}
inline const std::string& Point::_internal_occupation() const {
  return _impl_.occupation_.Get();
}
inline void Point::_internal_set_occupation(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.occupation_.Set(value, GetArenaForAllocation());
}
inline std::string* Point::_internal_mutable_occupation() {
  _impl_._has_bits_[0] |= 0x00000004u;
  return _impl_.occupation_.Mutable(GetArenaForAllocation());
}
inline std::string* Point::release_occupation() {
  // @@protoc_insertion_point(field_release:Point.occupation)
...
inline void Point::set_allocated_occupation(std::string* occupation) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Point.occupation)
}

// optional bool foreign_activity = 5;
inline bool Point::_internal_has_foreign_activity() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool Point::has_foreign_activity() const {
  return _internal_has_foreign_activity();
}
inline void Point::clear_foreign_activity() {
  _impl_.foreign_activity_ = false;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline bool Point::_internal_foreign_activity() const {
  return _impl_.foreign_activity_;
}
inline bool Point::foreign_activity() const {
  // @@protoc_insertion_point(field_get:Point.foreign_activity)
  return _internal_foreign_activity();
}
inline void Point::_internal_set_foreign_activity(bool value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.foreign_activity_ = value;
}
inline void Point::set_foreign_activity(bool value) {
  _internal_set_foreign_activity(value);
  // @@protoc_insertion_point(field_set:Point.foreign_activity)
}
